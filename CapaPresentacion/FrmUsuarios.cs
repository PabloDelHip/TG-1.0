    ...
    public partial class FrmUsuarios : Form
    {
        ...
        {
            {
                ...
                else
                {
                    ...
                    while (bandera == "0")
                    {
                        ...
                        string respuesta;
                        cls_usuario.m_Nombre = txtNombre.Text + Apellido;
                        cls_usuario.m_Puesto = txtPuesto.Text;
                        cls_usuario.m_Login = txtLogin.Text;
                        cls_usuario.m_Nivel = Convert.ToInt32(txtNivel.Text);
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            else if (btnModificar.Text == "Guardar")
            {
                ...
                string respuesta2="";
                cls_usuario.m_Nombre = txtNombre.Text + Apellido2;
                cls_usuario.m_Puesto = txtPuesto.Text;
                cls_usuario.m_Login = txtLogin.Text;
                cls_usuario.m_Nivel = Convert.ToInt32(txtNivel.Text);
                cls_usuario.m_Password = txtPassword.Text;
        ...
        private void dgvUsuarios_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtNivel.Text = Convert.ToString(row.Cells["Nivel"].Value);
        }
